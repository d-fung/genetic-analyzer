...
![Genetic Sequence Analyzer](https://img.shields.io/badge/React-19.2.0-blue) ![Tailwind CSS](https://img.shields.io/badge/TailwindCSS-3.3.0-38bdf8) ![License](https://img.shields.io/badge/license-MIT-green)
...
npm run build
```
Then drag `build/` folder to [netlify.com/drop](https://netlify.com/drop)
...
Add to `package.json`:
```json
"homepage": "https://yourusername.github.io/genetic-analyzer",
"scripts": {
...
- [ ] Open Reading Frame (ORF) finder with automatic gene prediction
- [ ] Restriction enzyme site mapping with common enzymes
- [ ] Multiple sequence alignment viewer
- [ ] BLAST-like sequence similarity search
- [ ] 3D protein structure visualization using Three.js
